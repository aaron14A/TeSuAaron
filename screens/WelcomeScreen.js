  ...
  render() {
    return (
      ...
      <Text style={styles.text}>Inside</Text>
        ...
        <View style={{flex:0.20, justifyContent:"center", alignItems:"center", padding:RFValue(10)}}>
          <Image
        ...
        <View style={{ flex: 0.10 }}>
          ...
          <View style={{flex:0.5, alignItems:"center", justifyContent:"center" , marginTop : -450}}>
          <TextInput
          ...
          <View style={{flex : 0.1, display : "flex", flexDirection : "row" , marginTop : 30}}>
          <TouchableOpacity
           // style={styles.button}
            onPress={() => {
